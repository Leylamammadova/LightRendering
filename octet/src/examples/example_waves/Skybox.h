...
namespace octet {
  ...
  public:
    ...
    GLuint create_cube_map() {
      ...
      app_utils::get_url(buffer[F_TOP], "src/examples/example_waves/top.jpg");
      app_utils::get_url(buffer[F_BOTTOM], "src/examples/example_waves/bottom.jpg");
      app_utils::get_url(buffer[F_LEFT], "src/examples/example_waves/left.jpg");
      app_utils::get_url(buffer[F_RIGHT], "src/examples/example_waves/right.jpg");
      app_utils::get_url(buffer[F_FRONT], "src/examples/example_waves/front.jpg");
      app_utils::get_url(buffer[F_BACK], "src/examples/example_waves/back.jpg");
      uint16_t format[6] = { 0 };
      uint16_t width[6] = { 0 };
      uint16_t height[6] = { 0 };
      for (int i = 0; i < 6; i++)
